...
pub enum LineColour { None, Yellow, Green, Pink, Blue, Orange, Purple, Custom(u32) }
impl Default for LineColour { fn default()->Self { Self::None } }
impl LineColour {
...
#[serde(rename_all="snake_case")]
pub enum ListType { None, Bullet, Number, Check }
impl Default for ListType { fn default()->Self{Self::None} }
